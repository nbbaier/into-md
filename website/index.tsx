  ...
  c.html(
    <html lang="en">
      <head>
        <title>into-md</title>
        <meta
          content="Fetch any URL. Get clean markdown. Feed it to your LLM."
          name="description"
        />
        <meta charset="UTF-8" />
            ...
            <section class="flex flex-col">
              ...
              <div class="mx-auto">
                <div class="my-2 flex flex-col items-center gap-3 sm:flex-row sm:gap-4">
                  <div class="custom-box-shadow w-full rounded-md border border-black bg-[#F8FBF8] px-4 py-2 text-center font-medium text-sm sm:w-auto">
                    URL
                  </div>
